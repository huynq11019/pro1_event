...
(
	...
	CONSTRAINT PK_BAN PRIMARY KEY (IDBAN,IDPHONG),
...
<<<<<<< Updated upstream
	QUYEN INT NOT NULL,
=======
	QUYEN INT NOT NULL, -- quyền = 0  là quản lý
>>>>>>> Stashed changes
	CONSTRAINT PK_NHANVIEN PRIMARY KEY (IDNV),
	CONSTRAINT FK_NAHNVIEN_BAN FOREIGN KEY (IDBAN,IDPHONG) REFERENCES BAN(IDBAN,IDPHONG)
...
(
	...
	MOTA NVARCHAR(30),
	TRANGTHAI bit , -- STATE CỦA NHIỆM VỤ
...
nhiệm vụ
insert into NHIEMVU(TENNVU,IDGIAIDOAN,MOTA,TRANGTHAI,FILEIN, NGAYBATDAU,DEADLINE,TGHT )
VALUES (?,?,?,?,?,?,?)
update NHIEMVU  set TENNVU=?,IDGIAIDOAN=?,MOTA=?,TRANGTHAI=?,FILEIN=?, NGAYBATDAU=?,DEADLINE=?,TGHT=? where IDNVU =?
>>>>>>> Stashed changes
